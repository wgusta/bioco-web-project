    ...
    <div className="min-h-screen bg-earth-white">
      ...
      <div className="lg:h-[50vh] flex items-center justify-center">
        <div className="bento-grid-container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          {/* Large Welcome Card - Apple (Green) with overlap - bigger for content */}
          <OrganicBentoBox type="apple" colSpan={12} rowSpan={3} className="md:col-span-8 lg:col-span-8 bento-overlap-1">
      ...
      <div className="bento-grid-container max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        {/* Saisonal & Demeter - Carrot with overlap - bigger for content */}
        <OrganicBentoBox type="carrot" colSpan={12} rowSpan={3} className="md:col-span-6 lg:col-span-6 bento-overlap-2">
        ...
        {/* Gemeinschaft - Beet with overlap - bigger for content */}
        <OrganicBentoBox type="beet" colSpan={12} rowSpan={3} className="md:col-span-6 lg:col-span-6 bento-overlap-3">
        ...
        {/* Aktuelles - Carrot - bigger for content */}
        <OrganicBentoBox type="carrot" colSpan={12} rowSpan={3} className="md:col-span-6 lg:col-span-4">
        ...
        {/* Events - Apple - bigger for content */}
        <OrganicBentoBox type="apple" colSpan={12} rowSpan={3} className="md:col-span-6 lg:col-span-4">
        ...
        {/* Wie funktioniert's - Beet - bigger for content */}
        <OrganicBentoBox type="beet" colSpan={12} rowSpan={3} className="md:col-span-6 lg:col-span-4">
